...
exports.refreshStrategy = exports.jwtStrategy = void 0;
...
let refreshStrategy = exports.refreshStrategy = class refreshStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, "jwt-refresh") {
    constructor(configService) {
        super({
            jwtFromRequest: passport_jwt_1.ExtractJwt.fromAuthHeaderAsBearerToken(),
            ignoreExpiration: false,
